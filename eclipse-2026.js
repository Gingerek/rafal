(() => {
  ...
  data.projects.push({
    ...
    photos: [
      ...
      { src: 'DSC00111-safe.jpg', alt: 'Partial solar eclipse crescent against a black sky' },
      { src: 'DSC00250-safe.jpg', alt: 'Partial solar eclipse seen through tree branches' },
